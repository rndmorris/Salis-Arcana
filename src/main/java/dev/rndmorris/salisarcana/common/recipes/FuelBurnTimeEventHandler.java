...
/**
 * Event handler to override the burn time of TC wooden slabs. {@link cpw.mods.fml.common.IFuelHandler}s are called too
 * late in {@link net.minecraft.tileentity.TileEntityFurnace#getItemBurnTime(ItemStack)} to fix the problem, so we
 * listen for the event instead, which is called before everything else.
 */
