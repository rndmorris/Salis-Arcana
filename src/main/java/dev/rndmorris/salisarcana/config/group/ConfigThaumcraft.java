...
public class ConfigThaumcraft extends ConfigGroup {
    ...
    public final ToggleSetting hungryDynamicReach = new ToggleSetting(
        this,
        "hungryDynamicReach",
        "If true, the radius within which hungry nodes can break blocks and attract entities will scale with the current amount of vis of the node..")
    ...
    public final ToggleSetting hungryModifierSpeed = new ToggleSetting(
        this,
        "hungryModifierSpeed",
        "If true, the rate at which hungry nodes will try to break blocks will be adjusted by their modifier: 20% more often when bright, 20% less often when pale, 50% less often when fading.")
            .setCategory(nodeBehaviorsCategory);

    public final ToggleSetting pureDynamicReach = new ToggleSetting(
        this,
        "pureDynamicReach",
        "If true, the radius within which pure nodes will convert their surroundings to Magical Forest will scale with the current amount of vis of the node. Small pure nodes that are embedded in silverwood logs will have roughly the same range as before.")
            .setCategory(nodeBehaviorsCategory)
            .setEnabled(false);
    ...
    public final ToggleSetting pureModifierSpeed = new ToggleSetting(
        this,
        "pureModifierSpeed",
        "If true, the rate at which pure nodes will convert their surroundings to Magical Forest will be adjusted by their modifier: 20% more often when bright, 20% less often when pale, 50% less often when fading.")
            .setCategory(nodeBehaviorsCategory);

    public final ToggleSetting sinisterDynamicReach = new ToggleSetting(
        this,
        "sinisterDynamicReach",
        "If true, the radius within which sinister nodes will convert their surroundings to the Eerie biome will scale with the current amount of vis of the node.")
            .setCategory(nodeBehaviorsCategory)
            .setEnabled(false);
    ...
    public final ToggleSetting sinisterModifierSpeed = new ToggleSetting(
        ...
        "If true, the rate at which sinister nodes will convert their surroundings to the Eerie biome and attempt to spawn furious zombies will be adjusted by their modifier: 20% more often when bright, 20% less often when pale, 50% less often when fading.")
            .setCategory(nodeBehaviorsCategory);

    public final ToggleSetting taintedDynamicReach = new ToggleSetting(
        this,
        "taintedDynamicReach",
        "If true, the radius within which tainted nodes will convert their surroundings to Tainted Lands and spawn taint tendrils will scale with the current amount of vis of the node.")
            .setCategory(nodeBehaviorsCategory)
            .setEnabled(false);
    ...
    public final ToggleSetting taintedModifierSpeed = new ToggleSetting(
        ...
        "If true, the rate at which tainted nodes will convert their surroundings to Tainted Lands and spawn taint tendrils will be adjusted by their modifier: 20% more often when bright, 20% less often when pale, 50% less often when fading.")
            .setCategory(nodeBehaviorsCategory);
