...
public abstract class MixinTileThaumatorium_HeatSources extends TileThaumcraft {
     ...
     * block meets our additional acceptable criteria. Because of our mixin point, we can force a successful "can heat
     * crucible" check by returning {@code mat} from the original method, since it should always equal itself.
     */
    @WrapOperation(
            method = "checkHeat",
            at = @At(
