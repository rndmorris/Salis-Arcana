...
@Mixin(EntityEmber.class)
abstract class MixinEntityEmber_EmitPlaceEvent extends EntityThrowable {

    public MixinEntityEmber_EmitPlaceEvent(World p_i1776_1_) {
        super(p_i1776_1_);
    }
    ...
    private boolean checkPlaceEvent(World world, int x, int y, int z, Block block, Operation<Boolean> original) {
        if (this.getThrower() instanceof EntityPlayer player) {
            return EventUtils.tryPlaceBlock(world, x, y, z, block, 0, 3, player);
        } else {
