...
public class MixinTileEldritchTrap_CreativeImmunity {
    ...
    @WrapOperation(method = "updateEntity", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/World;getClosestPlayer(DDDD)Lnet/minecraft/entity/player/EntityPlayer;"))
    public EntityPlayer getClosestSurvivalPlayer(World world, double x, double y, double z, double maxDistance, Operation<EntityPlayer> original) {
