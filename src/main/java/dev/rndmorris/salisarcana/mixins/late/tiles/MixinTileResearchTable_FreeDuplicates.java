...
public class MixinTileResearchTable_FreeDuplicates {
    ...
    @WrapOperation(method = "duplicate", at = @At(value = "INVOKE", target = "Lthaumcraft/api/aspects/AspectList;getAspects()[Lthaumcraft/api/aspects/Aspect;", remap = false), remap = false)
